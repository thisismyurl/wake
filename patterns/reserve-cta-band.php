...
<section class="wp-block-group alignfull cl-section cl-section--harbor" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16);padding-left:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5)">
	...
	<!-- wp:paragraph {"className":"is-style-cl-eyebrow cl-eyebrow","align":"center","style":{"color":{"text":"var:preset|color|fog"}}} -->
	...
	<!-- wp:heading {"level":2,"fontSize":"2xl","textAlign":"center","style":{"color":{"text":"var:preset|color|paper"},"spacing":{"margin":{"top":"var:preset|spacing|3","bottom":"var:preset|spacing|6"}}}} -->
	...
	<!-- wp:paragraph {"align":"center","fontSize":"md","style":{"color":{"text":"var:preset|color|fog"},"spacing":{"margin":{"bottom":"var:preset|spacing|8"}}}} -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-paper-color has-text-color wp-element-button" href="tel:+15550194420" style="border-color:var(--wp--preset--color--paper);border-width:1px"><?php echo esc_html__( 'Call the dock office', 'wake' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
